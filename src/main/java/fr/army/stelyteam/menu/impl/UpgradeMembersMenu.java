...
public class UpgradeMembersMenu extends FixedMenuOLD {

    public UpgradeMembersMenu(Player viewer, TeamMenuOLD previousMenu) {
        super(
            viewer,
            MenusOLD.UPGRADE_LVL_MEMBERS_MENU.getName(),
