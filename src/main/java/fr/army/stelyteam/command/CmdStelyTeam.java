...
import fr.army.stelyteam.command.subCommands.help.SubCmdAdmin;
import fr.army.stelyteam.command.subCommands.help.SubCmdHelp;
import fr.army.stelyteam.command.subCommands.info.SubCmdInfo;
import fr.army.stelyteam.command.subCommands.info.SubCmdList;
import fr.army.stelyteam.command.subCommands.info.SubCmdMoney;
import fr.army.stelyteam.command.subCommands.manage.SubCmdDelete;
import fr.army.stelyteam.command.subCommands.manage.SubCmdDowngrade;
import fr.army.stelyteam.command.subCommands.manage.SubCmdEditName;
import fr.army.stelyteam.command.subCommands.manage.SubCmdEditPrefix;
import fr.army.stelyteam.command.subCommands.manage.SubCmdUpgrade;
import fr.army.stelyteam.command.subCommands.member.SubCmdAddMember;
import fr.army.stelyteam.command.subCommands.member.SubCmdChangeOwner;
import fr.army.stelyteam.command.subCommands.member.SubCmdRemoveMember;
import fr.army.stelyteam.command.subCommands.team.SubCmdAccept;
import fr.army.stelyteam.command.subCommands.team.SubCmdDeny;
import fr.army.stelyteam.command.subCommands.utility.SubCmdHome;
import fr.army.stelyteam.command.subCommands.utility.SubCmdVisual;
